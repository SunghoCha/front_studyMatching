...
export default {
    ...
    async loadStudies(context, { page, sortOptions, search }) {
        ...
        // 검색어 추가
        if (search) {
            url.searchParams.append("titles", search);
        }
    ...
    async loadManagedStudies(context, { page, sortOptions, search }) {
        ...
        //url 세팅
        const url = new URL(`${apiUrl}/study/my-managed-study-list`);
        url.searchParams.append('page', page);
    ...
    async loadJoinedStudies(context, { page, sortOptions, search }) {
        ...
        //url 세팅
        const url = new URL(`${apiUrl}/study/my-joined-study-list`);
        url.searchParams.append('page', page);
    ...
    async loadStudyWishList(context, { page, sortOptions, search }) {
        ...
        //url 세팅
        const url = new URL(`${apiUrl}/study/my-study-wishlist`);
        url.searchParams.append('page', page);
